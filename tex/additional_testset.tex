...
- embeddings
- embeddings finetune
\mx{The performance gain on MultiNLI+SNLI most likely arises from the fact that almost 50\% of the replacement words used to generate the new dataset occur in MultiNLI in a way 612/1277 phrase replacement pairs ($p_p$, $p_h$) occur in the MultiNLI training data in contradiction pairs such that $p_p$ is in the premise and $p_h$ is in the hypothesis.}
-words
esim -wp